...
def test_outcome_rendering(loose_templar: WorkflowTemplar) -> None:
    """Test outcome rendering"""
    assert loose_templar.render("@{outcomes.Foo.bar}") == "ok"


def test_outcome_missing_action_rendering(loose_templar: WorkflowTemplar) -> None:
...
def test_strict_outcome_missing_key_rendering(strict_templar: WorkflowTemplar) -> None:
...
def test_status_rendering(loose_templar: WorkflowTemplar) -> None:
    """Test status rendering"""
    assert loose_templar.render("@{metadata.status.Foo}") == "SUCCESS"


def test_status_missing_action_rendering(loose_templar: WorkflowTemplar) -> None:
    """Test status missing action rendering"""
    with pytest.raises(ActionRenderError, match="Action not found"):
        loose_templar.render("@{meta.status['Unknown action']}")


def test_environment_rendering(loose_templar: WorkflowTemplar) -> None:
...
def test_context_rendering(loose_templar: WorkflowTemplar) -> None:
...
def test_unknown_expression_type_rendering(loose_templar: WorkflowTemplar) -> None:
...
def test_complex_rendering(loose_templar: WorkflowTemplar) -> None:
    """Test complex expression rendering"""
    assert (
...
def test_expression_with_spaces(loose_templar: WorkflowTemplar) -> None:
    """Test expression with space rendering"""
    assert loose_templar.render("@{ 'OK' if str(context.plugh) == 'xyzzy' else 'Not OK' }") == "OK"


def test_recursive_expression(loose_templar: WorkflowTemplar) -> None:
    """Test expression with nesting"""
    assert loose_templar.render("@{ context.waldo }") == "test"


def test_cycle_expression(loose_templar: WorkflowTemplar) -> None:
...
def test_dict_context_expression_getitem(loose_templar: WorkflowTemplar) -> None:
    """Test dict context expression via __getitem__"""
    assert loose_templar.render("@{ context.dictData[0]['a'] }") == "b"


def test_dict_context_expression_getattr(loose_templar: WorkflowTemplar) -> None:
    """Test dict context expression via __getattr__"""
    assert loose_templar.render("@{ context.dictData[0].a }") == "b"


def test_render_non_string_object(loose_templar: WorkflowTemplar) -> None:
    """Test rendering of the whole complex object"""
    assert loose_templar.render("@{ context.dictData }-@{ context.intval }") == "[{'a': 'b'}]-10"


def test_render_deep_context(loose_templar: WorkflowTemplar) -> None:
