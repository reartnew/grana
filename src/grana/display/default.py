...
class PrologueDisplay(BaseDisplay):
    ...
    def on_plan_interaction(self, workflow: Workflow) -> None:
        displayed_action_names_with_descriptions: list[str] = []
        default_selected_action_names_with_descriptions: list[str] = []
        full_description_to_names_map: dict[str, str] = {}
    ...
    @classmethod
    def _run_dialog(cls, choices: list[str], default: list[str]) -> list[str]:  # pragma: no cover
